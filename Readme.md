...
- **데이터 종류 정의 및 분류**: 지능화 구현을 위해 필요한 데이터를 정의하고, 성격에 따라 **실시간(시계열 데이터)** 및 비실시간(로그/이미지 데이터)으로 분류하여 관리 체계를 설계함.
    ...
    ![image24.png](attachment:9168e29d-6e39-494e-bca6-f186e2be5c3b:image24.png)
...
[media1.mp4](attachment:a93c50c5-ef4c-42d4-b637-aae8a0868c37:media1.mp4)
...
- **사용자 경험 중심 시각화**: 운영자의 즉각적인 대응을 위해 데이터 특성별 시각화 전략을 제시함.
    ...
    ![image13.png](attachment:0950e396-b170-4102-9644-919ebc9aa02c:image13.png)
